# -*- coding: utf-8 -*-
"""Add 'આપણે અને સમાજ' audio book: convert WAV->MP3, PDF->thumbnail, update audio_list.json."""
import json
import os
import re
import subprocess
...
# Ensure UTF-8 stdout to avoid Windows encoding issues
...
# Paths on desktop
AUDIO_FOLDER = r"C:\Users\davea\Desktop\આપણે અને સમાજ"
THUMBNAIL_PDF = r"C:\Users\davea\Desktop\આપણે અને સમાજ.pdf"
...
BOOK_TITLE = "આપણે અને સમાજ"
RELEASE_TAG = "aapne_ane_samaj"
...
def main():
    ...
    if add_book_to_json():
        ...
        print("Next: create GitHub release and upload MP3 files with same filenames:")
