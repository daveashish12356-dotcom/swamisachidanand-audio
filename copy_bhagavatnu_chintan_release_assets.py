# -*- coding: utf-8 -*-
"""Copy Bhagavatnu Chintan MP3s to numbered 1.mp3..N.mp3 for GitHub release."""
import os
import re
import shutil

AUDIO_FOLDER = r"C:\Users\davea\Desktop\ભાગવતનું ચિંતન"
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "audio-repo", "bhagavatnu_chintan_release")
